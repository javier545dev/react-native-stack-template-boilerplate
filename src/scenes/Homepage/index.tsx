...
const Home: FC = () => {
  ...
  const switchLocaleToEs = useCallback(() => {
  ...
  useLayoutEffect(() => {
    setOptions({
      ...
      headerTitle: () => <Icon as={FontAwesome5} name="react" color="RIVER" size="30px" />,
    })
  }, [setOptions])
      ...
      >
        ...
        <Flex flexDirection="row">
          <Button
            ...
            onPress={switchLocaleToEs}
            margin={2}
            isPressed={currentLocale === 'es'}
            _pressed={{
              backgroundColor: currentLocale === 'es' ? 'primary' : 'tertiary',
            }}
          >
